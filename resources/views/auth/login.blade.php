    ...
    <div class="login-card">
        ...
        <form action="{{ url('/login') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="input-group shadow-sm" style="border-radius: 8px; overflow: hidden; background-color: #1e293b;">
            ...
            <a href="#" class="btn btn-google-outline w-100 d-flex justify-content-center align-items-center gap-2">
